...
import UpdateProfileModal from '../components/HealthCare/UpdateUserModal'
    ...
    return (
        <div classNameName='HealthCare'>
            ...
            <div id="main-wrapper">
                ...
                <p className="brand-title" width="124px" height="33px"  style={{fontSize: "25px", marginTop: "30px"}}>HealthCare</p>
                    </a>
              ...
              <div className="dlabnav-scroll">
                <ul className="metismenu" id="menu">
                  <li className="dropdown header-profile">
                    <a className="nav-link" href="/profile.html" role="button" onClick={(e) => e.preventDefault()}>
                      ...
                      <div className="header-info ms-3">
                        <span className="font-w600">Hi,<b>{profile.name}</b></span>
                        <small className="text-end font-w400">{profile.email}</small>
                      </div>
                    </a>
                  </li>
                  <li>
                  ...
                  <UpdateProfileModal
                    ...
                    profile={profile} // Pass profile data to modal
                  />
                  <li>
                    <a href="#" aria-expanded="false">
