...
public class RegistrationController {
    ...
    public ResponseEntity<String>registerGuardian(@RequestBody @Validated GuardianDTO guardianDTO) {
        try{ 
        ...
        guardianService.register(guardian);

        return ResponseEntity.ok("Guardian registered successfully");
    } catch (Exception e) {
